...
const V_server = "https://testnet-algorand.api.statement.io";
...
export const getBalance = async (address)=>{
    ...
    const v_server_url = V_server + asset + "ps.io";
...
export const transfer  = async(from,to,sk,amount) =>{
 ...
 console.log("Transfer is finished");
}
...
export const RemoveAssetByID = async(from,assetIndex,sk)=> {
