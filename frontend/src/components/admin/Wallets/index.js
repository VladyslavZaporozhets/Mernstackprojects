...
export const Wallets = () => {
  ...
  {icon: PeraIcon,name : 'PeraWallet',value:'pera',ChainID : 0,Account : 'Not Connected',disabled:true},
  {icon: MetaMask,name : 'Metamask',value:'metamask',ChainID : 0,Account : 'Not Connected',disabled:true},
  ...
  return (
    <Container>
      <DashboardHeading title='Wallets' responsive = {false}>
       {screenWidth > 768 && <AccountBalance>Available BRT :<span>{brt}</span></AccountBalance>}
        <Select
          notReload
