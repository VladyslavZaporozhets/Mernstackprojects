...
export const Home = () => {
  ...
  const promotionList = [
    ...
    { title: 'Customers redeem discounts and rewards made simple', content: <span > <BsCheckCircle style={{width: '20px', height: '20px', paddingTop: '8px'}}/>To join Block Reward your customers will signup via email, once they have a profile set up they will be able to see what memberships your business will be offering <br /> <BsCheckCircle style={{width: '20px', height: '20px', paddingTop: '8px'}}/> As a retailer you will have a dedicated page to display special offers for your loyalty program members. While all members of the Block Reward ecosystem will have the ability to redeem some discounts, rewards are reserved for full business members or at the retailer’s discretion. <br /> <BsCheckCircle style={{width: '20px', height: '20px', paddingTop: '8px'}}/> Our platform allows for your customers to easily sign up and become a member of your loyalty program, and email is required to be part of the program, this is so your customers can regain access to their membership if they lose a device.</span> },
