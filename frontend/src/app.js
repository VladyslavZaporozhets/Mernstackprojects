...
import { MintMembership } from './pages/MintMembership'
      ...
      {!loading && (
        <>
          ...
          <Routes>
            ...
            <Route path='/u/MintMembership' element={<ProtectedRoute children={<MintMembership />} />} />
            ...
            <Route path = '/manager/page' element={<ProtectedRoute children={<Page />} />}  ></Route>
            <Route path = '/manager/discount' element={<ProctedManager children={<Discount />} />}  ></Route>
            <Route path = '/business/user' element={<ProtectedRoute children={<Employee />} />}  ></Route>
            <Route path = '/business/discount' element={<ProtectedRoute children={<BusinessDiscount />} />}  ></Route>
